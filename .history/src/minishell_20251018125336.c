...
// expose last status for debugging but not actually used for expansion
...
// PARSING NODES --------------------------------------------
// Grammar (right-binding split like the original pipeline/AND/OR handling):   cmd & cmd & ...     (background chains)
